#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════
# BULWARK — Pass 6: Adversarial Review & Final Report
# ════════════════════════════════════════════════════════════════════════
...
MAX_TURNS="${BULWARK_REVIEW_MAX_TURNS:-60}"
...
echo "*Generated by [Bulwark](https://github.com/cargopete/bulwark) — multi-pass smart contract audit pipeline.*" >> "$REPORT"
