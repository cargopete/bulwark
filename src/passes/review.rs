...
/// Used by the `doyran report` subcommand.
...
fn write_markdown_report(
    ...
    writeln!(
        f,
        "*Generated by [Doyran](https://github.com/cargopete/doyran) — multi-pass smart contract audit pipeline.*"
    )?;
